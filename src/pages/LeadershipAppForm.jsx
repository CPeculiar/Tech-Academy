...
export default function LeadershipAppForm() {
  ...
  const [currentStep, setCurrentStep] = useState(1);
   ...
   const slides = [
    '/TLBC-Slider2.png',
    'Leadership.jpg'  // Add your second image path here
  ];
...
const stateOptions = nigeriaStates.map(state => ({ value: state, label: state }));
    ...
    const { name, value, type, checked } = e.target;
        ...
        if (type === 'checkbox') {
          ...
          if (name === 'learningTrack') {
            // Handle multiple selection for learning track
            setFormData(prev => ({
              ...prev,
              [name]: checked 
                ? [...(prev[name] || []), value]
  ...
  const validateStep = () => {
    ...
    switch(currentStep) {
      case 1:
        ...
        if (!formData.otherNames.trim()) errors.otherNames = 'Your other Names are required';
      ...
      case 3:
        if (!formData.church) errors.church = 'Church is required';
        if (!formData.zone) errors.zone = 'Zone is required';
        if (!formData.department) errors.department = 'Department is required';
        if (!formData.office) errors.office = 'Your position(s) is required';
        break;
  ...
  const handleStateChange = (selected, field) => {
  ...
  const renderHeroSection = () => (
    <section className="text-white pt-44 md:pt-20">
    <div 
      className="relative bg-cover bg-center h-screen flex items-center transition-all duration-1000 ease-in-out"
      style={{ 
        ...
        <div className="flex flex-col-reverse md:flex-row items-center space-y-6 md:space-y-0 md:space-x-8">
          <div className="w-full md:w-1/2 text-center md:text-left space-y-4">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight">
              Equip Yourself for Service – Church Workers' Training 
            </h1>
            <p className="text-sm md:text-base text-white mb-4">
              This training is designed to equip church workers and leaders to serve more effectively in their ministry roles.
              Gain the knowledge and skills needed for personal growth, effective service, and meaningful contribution to the church's growth.
            </p>
  ...
  const renderStep = () => {
    switch(currentStep) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                {formErrors.otherNames && 
                  <p className="text-red-500 text-sm">{formErrors.otherNames}</p>
                }
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <label>State of Residence</label>
                <Select
                  ...
                  value={stateOptions.find(s => s.value === formData.stateOfResidence) || null}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                />
                {formErrors.office && 
                  <p className="text-red-500 text-sm">{formErrors.office}</p>
                }
              </div>
            </div>
          </div>
      ...
      case 4:
        return (
          ...
          <div>
            <label>Expectations (max 100 words)</label>
            <textarea
              name="motivation"
              ...
              placeholder="Tell us your expectations for this trainig..."
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full border-2 border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300"
          ...
          <div>
            ...
            >
              ...
              <option value="ChurchAnnouncement">Church Announcement</option>
              <option value="Social Media">Social Media</option>
              <option value="Brethren/WordOfMouth">Brethren/Word of Mouth</option>
          ...
          return (
            <div className="text-center space-y-4">
              ...
              <div className="bg-gray-100 p-6 rounded-lg text-left">
                ...
                <p>Name: {formData.firstName} {formData.otherNames}</p>
                ...
                <h4 className="text-xl font-bold mt-4 mb-3">Church Information</h4>
                <p>Church: {formData.church}</p>
                <p>Zone: {formData.zone}</p>
    ...
    return (
      <div className="min-h-screen bg-gray-900 text-white">
        ...
        <section className="py bg-gray-300 text-black">
