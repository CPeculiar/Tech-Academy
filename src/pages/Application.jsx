  ...
  if (Object.keys(validationErrors).length > 0) {
    ...
    try {
      ...
      setMotivationWordCount(0);
        ...
        //   haveLaptop: formData.haveLaptop,
        //   haveSmartPhone: formData.haveSmartPhone,
        ...
        // await setDoc(doc(db, "applicants", userCredential.user.uid), userData);
  
        // alert(`Form submitted successfully!. We will reach out to you shortly`);   
